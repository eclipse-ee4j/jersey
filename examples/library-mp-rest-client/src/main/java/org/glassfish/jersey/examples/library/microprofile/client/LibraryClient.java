...
package org.glassfish.jersey.examples.library.microprofile.client;
...
public class LibraryClient {
    ...
    private static class ClientThread extends Thread {
        ...
        public void run() {
            try {
                ...
                BookingService bookingClient = RestClientBuilder.newBuilder()
                        .baseUri(new URI("http://localhost:8080/booking"))
                        .build(BookingService.class);
    ...
    private static ArrayList<Date> randomDateArray(){
        ...
        int randomDay = (int) (Math.random() * 30);
        calendar.set(2020, Calendar.JULY, randomDay, 0, 0, 0);
        Date fromDate = calendar.getTime();

        randomDay = (int) (Math.random() * (31 - randomDay) + randomDay);
        calendar.set(2020, Calendar.JULY, randomDay, 0, 0, 0);
